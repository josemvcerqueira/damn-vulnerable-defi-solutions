...
describe('[Challenge] Free Rider', function () {
    ...
    it('Exploit', async function () {
        ...
        const HackFreeRiderFactory = await ethers.getContractFactory('HackFreeRider', attacker);
        const hackFreeRider = await HackFreeRiderFactory.deploy(this.buyerContract.address, this.nft.address, this.uniswapPair.address, attacker.address, this.weth.address, this.marketplace.address);
        await hackFreeRider.attack();
    });
