...
describe('[Challenge] Climber', function () {
    ...
    it('Exploit', async function () {        
        ...
        const climberHack = await ClimberHackFactory.deploy();
        await climberHack.attack(this.timelock.address,this.vault.address, this.token.address, attacker.address);
    });
