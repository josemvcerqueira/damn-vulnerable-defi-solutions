...
describe('[Challenge] Backdoor', function () {
    ...
    it('Exploit', async function () {
        ...
        const HackWalletFactory = await ethers.getContractFactory('HackWallet', attacker);
        const hackWallet = await HackWalletFactory.deploy();
        await hackWallet.attack(this.walletFactory.address, this.walletRegistry.address, this.masterCopy.address, users, this.token.address, attacker.address);
    });
